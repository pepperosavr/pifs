    ...
    st.markdown(
        ...
        <div class='insight'>
            ...
            <div style='display:grid; grid-template-columns:repeat(auto-fit,minmax(240px,1fr)); gap:12px;'>
                <div>📦 MREF — индекс МосБиржи, отражающий динамику фондов складской и индустриальной недвижимости. Включает несколько ЗПИФов, инвестирующих в объекты логистики и склады класса A/B.</div>
                <div>📈 Фонды в составе индекса обеспечивают регулярные рентные выплаты — источник дохода даже при падении фондового рынка.</div>
                <div>🛡 Добавление слабо коррелированного актива снижает волатильность портфеля без потери доходности — классический эффект диверсификации.</div>
                <div>⚖️ Теория Марковица: некоррелированный актив сдвигает портфель ближе к эффективной границе — растёт коэффициент Шарпа.</div>
                <div>🏗 Рост e-commerce и 3PL-логистики создаёт структурный дефицит складов класса A в РФ — долгосрочный фундаментальный драйвер.</div>
                <div>🔒 Инфляционная защита: арендные ставки индексируются, стоимость объектов растёт вместе с затратами на строительство.</div>
            </div>
        </div>
        """,
        unsafe_allow_html=True,
