...
# 1) ТОЛЬКО НУЖНЫЕ ФОНДЫ (ISIN + человекочитаемые названия)
FUND_MAP = {
...
# 2) КНОПКА-РЕЖИМ НАВЕРХУ: История / Сравнение сегодня vs пред. торговыи день
mode = st.radio(
    "Режим просмотра",
